...
class DBConn:
    ...
    def _convert_sql(self, sql):
        ...
        # SQLite integer primary-key syntax
        ...
        # This makes migrations safe on existing deployments.
        if (
...
def init_db():
    ...
    # =====================================================
    #
    # Older Render/PostgreSQL databases already contain
    # the invoices table, but that old table may not contain
    # all columns used by the current dashboard.
    #
    # CREATE TABLE IF NOT EXISTS does NOT modify an existing
    # table.
    #
    # Therefore all invoice columns are checked separately.
    #
    # On PostgreSQL DBConn automatically converts:
    #
    ...
    #
    # This prevents deployment errors if a column already exists.
    # =====================================================
...
def dashboard():
    ...
    # iOS/Safari can reopen an old /dashboard URL.
    if session.get("role") == "driver":
